...
namespace AutoFlow.UnitTests.Application.Services
{
    public class ClienteServiceTests
    {
        ...
        {
            var dto = new CriaVeiculoDto("João da Silva", "12345678901", "11999999999", "joao@email.com");
        ...
        {
            var dto = new CriaVeiculoDto("", "12345678901", "11999999999", "joao@email.com");
        ...
        public async Task AtualizarAsync_ComClienteExistenteEDadosValidos_DeveAtualizarERetornarSucesso()
        {
            ...
            var dto = new AtualizaVeiculoDto("Maria Souza", "12345678000199", "11888888888", "maria@email.com");
        ...
        {
            var dto = new AtualizaVeiculoDto("", "12345678000199", "11888888888", "maria@email.com");
